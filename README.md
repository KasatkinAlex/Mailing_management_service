...
создайте и примените мигhации (python manage.py makemigrations, python manage.py migrate)
установите и запустите Redis
для запуска проекта наберите в терминале команду python manage.py runserver
перейдите по адресу: http://127.0.0.1:8000
зарегистрируйтесь на сайте, добавте сообщение, добавьте клиентов, создайте рассылку.
